...
Route::group(['middleware' => ['auth', 'activated', 'activity', 'checkblocked']], function () {
    ...
    Route::get('/cartes', 'App\Http\Controllers\PathController@cartes');
    Route::get('/rib', 'App\Http\Controllers\PathController@rib');
    Route::get('/virements', 'App\Http\Controllers\PathController@virements');
    Route::get('/operations', 'App\Http\Controllers\PathController@operations');
    // Activation Routes
...
Route::group(['middleware' => ['auth', 'activated', 'activity', 'twostep', 'checkblocked']], function () {
    ...
    Route::get('/home', 'App\Http\Controllers\WelcomeController@welcome');
